...
class KsGlobalDiscountSales(models.Model):
    ...
    ks_global_discount_type = fields.Selection([('percent', 'Percentage'), ('amount', 'Amount')],
                                               ...
                                               default='percent')
    ks_global_discount_rate = fields.Float('Global Discount',
                                           readonly=True,
                                           states={'draft': [('readonly', False)], 'sent': [('readonly', False)]})
    ks_amount_discount = fields.Monetary(string='Global Discount', readonly=True, compute='_amount_all', store=True,
