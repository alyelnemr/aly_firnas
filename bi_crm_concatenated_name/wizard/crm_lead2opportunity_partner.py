...
class Lead2OpportunityPartner(models.TransientModel):
    ...
    partner_ids = fields.Many2many('res.partner', 'crmlead_partner_ids_rel', 'crmlead_partner_ids_id', 'partner_ids_partner_id',string="Partner")
    client_name = fields.Many2many('res.partner', 'crmlead_client_rel', 'crmlead_clientname', 'crm_partner_id', string="End Client")
